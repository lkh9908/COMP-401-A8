...
//							JSlider gp = new JSlider(5, 10, 5);
//							gp.setMajorTickSpacing(10);
//							gp.setSnapToTicks(true);
//							gp.setPaintTicks(true);
//							gp.setPaintLabels(true);
//							optionPane.setMessage(new Object[] { "Select a value: ", gp });
